const StarterPage = () => {
	return (
		...
		<div>
			...
			<p>There are many different types of effects pedals in the market today. While Pedal Base has some of the most popular ones, there are always creators large and small adding new pedals to the soundscape. That's where you come in! Pedal Base is an interactive site that allows you to add your favorite pedal to the database. Get started HERE.</p>
